...
public class EntityExtraction {
    ...
    public static Optional<Entity> extractClassEntityCalls(Class<?> clazz, AnalysisMetaAccess metaAccess, Inflation bb) {
        ...
        try {
            for (ResolvedJavaField f : analysisType.getInstanceFields(false)) {
                ...
                try {
                    ...
                    if (field.getWrapped().getAnnotations().length > 0 || isLombok(analysisType)) {
                        ...
                        if (typeName.equals("Set") || typeName.equals("List") || typeName.equals("Queue") || typeName.equals("Deque") || typeName.equals("Map") || typeName.equals("Array")) {
                        ...
                        } else if (typeName.equals("byte") || typeName.equals("short") || typeName.equals("int") || typeName.equals("long") || typeName.equals("float") || typeName.equals("double") ||
    ...
    // Because Lombok annotations are processed at compile-time, they are not retained in the
    // compiled
    // class' file annotation table
    public static boolean isLombok(AnalysisType analysisType) {

        ResolvedJavaField[] fields = analysisType.getInstanceFields(false);
        AnalysisMethod[] methods = ((AnalysisMethod[]) analysisType.getDeclaredMethods());
        ...
        for (ResolvedJavaField f : fields) {
            ...
            for (AnalysisMethod method : methods) {
                if (method.getName().toLowerCase().equals("get" + field.getName().toLowerCase()) || method.getName().toLowerCase().equals("is" + field.getName().toLowerCase())) {
                    getFound = true;
                }
